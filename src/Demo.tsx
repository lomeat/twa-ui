        ...
        <Column>
          <Container height={240}>
            ...
            <Profile
              ...
              hotkey="p"
              onClick={() => {
                console.log("make profile action");
              }}
            />
          </Container>
